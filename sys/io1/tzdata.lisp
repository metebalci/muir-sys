...
;;; generated by sys/io1/gen-tzdata.py from tzdata 2026c: do not edit.
;;; every zone and link of tzdata.zi (436 zones, 162 links) with the POSIX
;;; TZ string its TZif file ends with, the rule the zone follows today.
;;; LOOKUP-TIMEZONE-NAME in SYS: IO1; TIME reads it.

(defconst *tzdata-version* "2026c"
  "The tzdata release that *TZDATA-ZONES* was generated from.")

(defconst *tzdata-zones*
  '(("Africa//Abidjan" . "GMT0")
    ("Africa//Accra" . "GMT0")
    ...
    ("Zulu" . "UTC0"))
  "Alist of tzdata zone names and the POSIX TZ string of each.")
