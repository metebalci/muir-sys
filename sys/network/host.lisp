...
;; the :ITS mixin (HOST-ITS-MIXIN) went with ITS support; this system never
...
;; the :MULTICS mixin (HOST-MULTICS-MIXIN) went with Multics support;
;; this system never talks to a Multics host.
