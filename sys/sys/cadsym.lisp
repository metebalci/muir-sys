...
;; machine-id, quux's id word (the name muir, muir-fpga and this system share),
;; read-only: signature 0x5155 in bits 31:16, the hardware
...
(defprop machine-id (or (source-p (field function-source 16))
		     (error)) cons-lap-sym)
