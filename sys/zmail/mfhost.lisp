...
;; this used to also test for an :ITS host, appending its //G
...
;; the FS:ITS-PATHNAME-MIXIN methods that offered and detected
...
(DEFUN NAME-FROM-MENU-VALUE (VALUE ITEM-LIST)
  (DOLIST (ELEM ITEM-LIST)
    (AND (EQ (TV:MENU-EXECUTE-NO-SIDE-EFFECTS ELEM) VALUE)
	 (RETURN (CAR ELEM)))))

;; Tenex and TOPS-20 mail-file support (TENEX-MAIL-FILE-MIXIN,
...
(DEFMETHOD (UNIX-INBOX-BUFFER :BEFORE :PARSE-MSG) (MSG -STATUS-)
  ...
  (PUTPROP -STATUS- T 'UNSEEN))

;; VMS mail-file support (VMS-MAIL-FILE-MIXIN, VMS-MAIL-FILE-BUFFER,
